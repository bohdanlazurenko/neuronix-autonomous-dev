...
- **AR-004**: All forms MUST have proper labels, error messages, and validation feedback
- **AR-005**: Feature MUST be testable with screen readers (NVDA, JAWS, VoiceOver)
- **AR-006**: Feature MUST respect user preferences (prefers-reduced-motion, prefers-color-scheme)

### Performance Requirements *(mandatory for UI features)*

- **PR-001**: Page/component load time MUST be < 1.5 seconds on 3G connection
- **PR-002**: Interactions MUST provide feedback within 100ms
- **PR-003**: Bundle size impact MUST be documented and justified if > 50KB
- **PR-004**: Images MUST be optimized (modern formats, lazy loading)
